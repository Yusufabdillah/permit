...
class F_Pending extends MY_Controller {

    private $VIEW_PATH = 'pending';
    ...
    public function index() {
        ...
        $data['get_pengajuan'] = $this->M_Pengajuan->getPengajuan('getPending');
        $this->template->frontend($this->VIEW_PATH."/index", "Daftar Pengajuan Pending", $data);
    }
    ...
    public function form($idPengajuan = null) {
        ...
        $this->template->frontend($this->VIEW_PATH."/form", "Update Pengajuan", $data);
    }
    ...
    public function aktifkanPengajuan() {
        $RETURN_MODEL = $this->M_Pengajuan->aktifkanPengajuan($_POST);
        $this->session->set_flashdata("NOTIFY", $RETURN_MODEL["STATUS"]."/".$RETURN_MODEL['PESAN']);
        redirect($this->router->fetch_class().'/index');
    }
