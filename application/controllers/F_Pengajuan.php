...
class F_Pengajuan extends MY_Controller {

    private $VIEW_PATH = 'pengajuan';
    ...
    public function index() {
        ...
        $data['get_pengajuan'] = $this->M_Pengajuan->getPengajuan('getDraft');
        if (empty($data['get_pengajuan'])) {
            self::form();
        } else if (!empty($data['get_pengajuan'])) {
    ...
    public function form($idPengajuan = null) {
        if (empty($idPengajuan)) {
            ...
            $data['get_sub_subk'] = $this->M_SSKategori->getSSKategori('getAll', NULL, NULL, NULL, false);
            ...
            $this->template->frontend($this->VIEW_PATH."/form", "Pengajuan Baru", $data);
        } if (!empty($idPengajuan)) {
            ...
            $this->template->frontend($this->VIEW_PATH."/form", "Draft Pengajuan", $data);
        }
    }
    ...
    public function AJAX() {
        ...
        if ($Fungsi == 'toPerusahaan') {
            $data['get_perusahaan'] = $this->M_PerusahaanAkses->getPerusahaanAkses('getDataSite', null, null, $_POST['idKecamatan']);
