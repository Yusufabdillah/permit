...
class Ajax_pagination{
    ...
    var $num_links       =  2;
    var $cur_page        =  0;
    var $first_link      = '<a href="#" class="page">first</a>';
    var $next_link       = '&#187;';
    var $prev_link       = '&#171;';
    var $last_link       = '<li class="page-item"><span class="page-link">Last</span></li>';
    var $uri_segment     = 3;
    var $full_tag_open   = '<div class="pagging text-center"><nav><ul class="pagination justify-content-center">';
    ...
    function create_links(){
        ...
        if ($this->show_count){
            ...
            $info = '<li class="page-item"><span class="page-link"> Showing ' . ( $curr_offset + 1 ) . ' to ' ;
            ...
            $info .= ' of ' . $this->total_rows . ' | </span></li>';
            $output .= $info;
        }
