...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="fa fa-check-circle-o"></i> Persetujuan Pengajuan
        </h1>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="block full">
                <div class="block-title">
                    <h2><strong>Daftar</strong> Pengajuan</h2>
                </div>
                <ul class="task-list">
                    <?php
                            ...
                            <li>
                                ...
                                <div class="row">
                                    <div class="btn-group pull-right">
                                        <a class="btn btn-md btn-primary" href="<?= site_url('F_Approve/form/'.encode_str($data->idPengajuan)); ?>"><i class="fa fa-book"></i> Detail Pengajuan</a>
                                        <a data-toggle="modal" class="btn btn-md btn-success" href="#modalApprove"><i class="fa fa-check-circle-o"></i> Setujui</a>
                                    </div>
                                </div>
                            </li>
                            <hr>
                            <?php
                            $parsingData['get_pengajuan'] = $data;
