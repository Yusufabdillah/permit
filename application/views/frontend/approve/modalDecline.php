...
<div class="modal fade" id="modalDecline">
    <form action="<?= site_url('F_Approve/declinePengajuan'); ?>" method="post">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="fa fa-times-circle-o text-danger"></i> Tolak Pengajuan</h4>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="idPengajuan" id="d_idPengajuan" required>
                    <input type="hidden" name="draft_createdby" id="d_draft_createdby" required>
                    <div class="row">
                        <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <textarea name="ktrDecline" id="CK_ktrDecline" class="ckeditor"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
