                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-offset-9 col-md-3 btn-group">
                                    ...
                                    <a
                                            ...
                                            data-d_idest="<?= $get_pengajuan->idEstafet; ?>"
                                            data-d_jdl="<?= $get_pengajuan->namaJudul; ?>"
                                            data-d_koor="<?= $get_pengajuan->approve_createdby; ?>"
                                            data-d_nama_asal="<?= $get_pengajuan->ASAL_USR_namaUser; ?>"
                                            data-d_iduser_asal="<?= $get_pengajuan->idUser_asal; ?>"
                                            data-d_idperusahaan="<?= $get_pengajuan->idPerusahaan_asal; ?>"
                                            data-d_namaprs="<?= $get_pengajuan->ASAL_PRS_namaPerusahaan." di ".$get_pengajuan->ASAL_PRS_lokasiPerusahaan; ?>"

                                            href="#modalDecline" data-toggle="modal" class="modalDecline btn btn-sm btn-danger">
                                        <i class="fa fa-times-circle"></i> Tolak
                                    </a>
                                    <a
                                            data-a_id="<?= $get_pengajuan->idPengajuan; ?>"
                                            data-a_idest="<?= $get_pengajuan->idEstafet; ?>"
                                            data-a_jdl="<?= $get_pengajuan->namaJudul; ?>"
                                            data-a_koor="<?= $get_pengajuan->approve_createdby; ?>"
                                            data-a_nama_asal="<?= $get_pengajuan->ASAL_USR_namaUser; ?>"
                                            data-a_iduser_asal="<?= $get_pengajuan->idUser_asal; ?>"
                                            data-a_idperusahaan="<?= $get_pengajuan->idPerusahaan_asal; ?>"
                                            data-a_namaprs="<?= $get_pengajuan->ASAL_PRS_namaPerusahaan." di ".$get_pengajuan->ASAL_PRS_lokasiPerusahaan; ?>"

                                            href="#modalApprove" data-toggle="modal" class="modalApprove btn btn-sm btn-success">
...
$this->load->view('frontend/estafet/modalDecline');
$this->load->view('frontend/estafet/modalApprove');
