...
?>
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-file-o"></i><i class="fa fa-send"></i> Edit Pengajuan Estafet
            </h1>
        </div>
    </div>
                ...
                <div class="block-title">
                    ...
                    if (isset($get_pengajuan)) {
                        if (!empty($get_pengajuan->ktrDecline)) {
                            ...
                            <?php
                            $this->load->view('frontend/pengajuan/modalKetDecline');
                        }
                    }
                    ?>
                    <h2><strong>Form</strong> Pengajuan Baru</h2>
                </div>
                <form id="formPengajuan" action="<?php echo base_url('F_Estafet/savePengajuan'); ?>" method="post" class="form-horizontal">
                    <?php
                    if (isset($get_pengajuan)) {
                        ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group" id="AJAX_idCurrency">
                                        <input type="hidden" name="idCurrency" value="<?= isset($get_pengajuan) ? $get_pengajuan->idCurrency : null; ?>">
						...
						<div class="col-md-3">
							<div class="form-group" style="margin-left: 10px">
								...
								<label
									...
									<input
										<?= !isset($get_pengajuan->idPengajuan) ? 'disabled' : null; ?>
						...
						<div class="col-md-9">
							<div class="form-group">
								<div class="col-md-offset-9 col-md-3 btn-group">
									<a href="<?= site_url('F_Estafet/index'); ?>" class="btn btn-sm btn-warning"><i
                    ...
                    <?php
                    $this->load->view('frontend/estafet/modalSubmit');
                    ?>
                </form>
            </div>
        </div>
...
<?php
$this->load->view('frontend/estafet/JS');
$this->load->view('frontend/estafet/JSValidasi');
$this->load->view('frontend/estafet/JSSelect2');
if (isset($get_pengajuan)) {
    $currency['get_idCurrency'] = $get_pengajuan->idCurrency;
    $this->load->view('frontend/estafet/AJAX', $currency);
} if (!isset($get_pengajuan)) {
    $this->load->view('frontend/estafet/AJAX');
}
$this->load->view('frontend/estafet/JSSwal');
