...
<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form action="<?= site_url("F_Persyaratan/deletePersyaratan"); ?>" method="post">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="namaPersyaratan" id="d_namaPersyaratan" required>
                    <div class="form-group m-form__group">
                        <label>
                            Document Requirements
                        </label>
                        <input type="text" readonly class="form-control m-input" id="d_namaPersyaratan">
                    </div>
                    <hr>
                    <h3>
                        Are you sure ?
