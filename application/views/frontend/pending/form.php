...
?>
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-file-o"></i> Draft Pengajuan
            </h1>
        </div>
    </div>
            ...
            <div class="block full">
                <div class="block-title">
                    ...
                    if (isset($get_pengajuan)) {
                        if (!empty($get_pengajuan->pending_ktr)) {
                            ?>
                            <div class="block-options pull-right">
                                <a href="#modalKetPending" data-toggle="modal" class="btn btn-alt btn-sm btn-warning"><i class="fa fa-info-circle"></i> Informasi Pending</a>
                            </div>
                            <?php
                            $this->load->view('frontend/pending/modalKetPending');
                        }
                    }
                    ?>
                    <h2><strong>Form</strong> Pengajuan</h2>
                </div>
                <form id="formPengajuan" action="<?php echo base_url('F_Pending/savePengajuan'); ?>" method="post" class="form-horizontal">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            foreach ($get_referensi as $data) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="*">
                                                        <label class="switch switch-success"><input type="checkbox" value="<?= $data->idReferensi; ?>" <?= array_search($data->idReferensi ,$get_persyaratan_pengajuan) !== false ? 'checked' : null; ?> name="persyaratanPengajuan[]"><span></span></label>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-striped">
                                            <tr>
                                                ...
                                                <td width="*">
                                                    <label class="switch switch-success"><input type="checkbox" value="1" <?= $get_pengajuan->statusOSSPengajuan == true ? 'checked' : null; ?> name="<?= $OSS['name']; ?>"><span></span></label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group" id="AJAX_idCurrency">
                                        <input type="hidden" name="idCurrency" value="<?= $get_pengajuan->idCurrency; ?>">
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-actions">
                                <div class="col-md-offset-9 col-md-3 btn-group">
                                    <a href="<?= site_url('F_Pending/index'); ?>" class="btn btn-sm btn-warning"><i
                                                class="fa fa-reply"></i> Kembali</a>
                                    <button type="button" data-toggle="modal" data-target="#modalSimpan"
                                            class="btn btn-sm btn-success"><i class="fa fa-save"></i> Simpan
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php
                    $this->load->view('frontend/pending/modalSimpan');
                    ?>
                </form>
            </div>
        </div>
...
$this->load->view('frontend/pending/JSValidasi');
$this->load->view('frontend/pending/JSSelect2');
if (isset($get_pengajuan)) {
    $currency['get_idCurrency'] = $get_pengajuan->idCurrency;
    $this->load->view('frontend/pending/AJAX', $currency);
} if (!isset($get_pengajuan)) {
    $this->load->view('frontend/pending/AJAX');
}
$this->load->view('frontend/pending/JSSwal');
