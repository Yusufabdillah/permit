        ...
        columns: [
                ...
                template: function (row) {
                    ...
                    <div class="btn-toolbar" role="toolbar">\
                        <div class="btn-group" role=""group>\
                            ...
                            <a\
                             data-d_id="'+row.idDivisi+'"\
                             data-d_nama="'+row.namaDivisi+'"\
            ...
            },
            {
                ...
                template: function (row) {
                    ...
                    return '<span class="m-badge ' + status[row.statusDivisi].class + ' m-badge--wide">' + status[row.statusDivisi].title + '</span>';
                }
            },
            {
                field: "createdBy",
