                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <select class="form-control m-select2" id="select_idAspek" name="idAspek">
                                        <option></option>
                                        <?php
                                        foreach ($get_aspek as $KEY_ARRAY => $data) {
                                            ?>
                                            <option <?php
                                            if (!empty($get_kategori)) {
                                                if ($get_kategori->idAspek === $data->idAspek) {
                                                    echo 'selected';
                                                } else {
                                                    null;
                                                }
