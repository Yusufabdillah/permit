                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            <i class="la la-list-ol"></i> Tabel Data Persyaratan
                        </h3>
                    </div>
                </div>
                <?php
                if ($get_persyaratan !== '401') {
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="<?= site_url('b_persyaratan/form'); ?>" class="btn m-btn--pill btn-accent"
                                   data-container="body"
                                   data-toggle="m-popover"
                                   data-placement="left"
                                   data-skin="dark"
                                   data-html="true"
                                   data-content="<i class='la la-info-circle'></i> Tambah Dokumen Persyaratan"
                                >
...
<?php
$this->load->view('backend/persyaratan/modalDelete');
$this->load->view('backend/persyaratan/JSDatatable');
$this->load->view('backend/persyaratan/JSNotify');
$this->load->view('backend/persyaratan/JS');
