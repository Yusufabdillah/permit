                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            <i class="la la-list-ol"></i> Tabel Data Sub Sub Kategori
                        </h3>
                    </div>
                </div>
                <?php
                if ($get_subSubk !== '401') {
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            ...
                            <li class="m-portlet__nav-item">
                                <a href="<?= site_url('b_sskategori/form'); ?>" class="btn m-btn--pill btn-accent"
                                   data-container="body"
                                   data-toggle="m-popover"
                                   data-placement="left"
                                   data-skin="dark"
                                   data-html="true"
                                   data-content="<i class='la la-info-circle'></i> Tambah Sub Sub Kategori"
                                >
...
<?php
$this->load->view('backend/kategori_sub_sub/modalDelete');
$this->load->view('backend/kategori_sub_sub/JSDatatable');
$this->load->view('backend/kategori_sub_sub/JSNotify');
$this->load->view('backend/kategori_sub_sub/JS');
