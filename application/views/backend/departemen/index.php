                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            <i class="la la-list-ol"></i> Tabel Data Departemen
                        </h3>
                    </div>
                </div>
                <?php
...
<?php
$this->load->view('backend/departemen/modalDelete');
$this->load->view('backend/departemen/JSDatatable');
$this->load->view('backend/departemen/JSNotify');
$this->load->view('backend/departemen/JS');
