        ...
        columns: [
                ...
                template: function (row) {
                    ...
                    <div class="btn-toolbar" role="toolbar">\
                        <div class="btn-group" role=""group>\
                            ...
                            <a\
                             data-d_id="'+row.idKlasifikasi+'"\
                             data-d_nama="'+row.namaKlasifikasi+'"\
            ...
            },
            {
                ...
                template: function (index) {
                    return index.idKlasifikasi;
                }
            },
            {
                field: "namaKlasifikasi",
                textAlign: 'center',
                width: 250,
            ...
            {
                field: "kompleksitasKlasifikasi",
                textAlign: 'center',
                width: 200,
                title: "Kompleksitas",
                template: function (row) {
                    var status = {
                        0: {'title': 'Non Set', 'class': 'm-badge--brand'},
                        1: {'title': 'Normal', 'class': ' m-badge--success'},
                        2: {'title': 'Lumayan Rumit', 'class': ' m-badge--warning'},
                        3: {'title': 'Rumit', 'class': ' m-badge--danger'},
                        4: {'title': 'Sangat Rumit', 'class': ' m-badge--metal'},
                    };
                    return '<span class="m-badge ' + status[row.kompleksitasKlasifikasi].class + ' m-badge--wide">' + status[row.kompleksitasKlasifikasi].title + '</span>';
                }
            },
            {
                field: "createdBy",
