                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">
                                    <i class="la la-list-ol"></i> Tabel Data Negara
                                </h3>
                            </div>
                        </div>
                    <?php
                    if ($get_negara !== '401') {
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                ...
                                <li class="m-portlet__nav-item">
                                    <a href="<?= site_url('b_negara/form'); ?>" class="btn m-btn--pill btn-accent"
                                       data-container="body"
...
<?php
$this->load->view('backend/negara/modalDelete');
$this->load->view('backend/negara/JSDatatable');
$this->load->view('backend/negara/JSNotify');
$this->load->view('backend/negara/JS');
